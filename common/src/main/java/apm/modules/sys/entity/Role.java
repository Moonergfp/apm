...
public class Role extends BaseEntity {
	...
	private Set<User> userList = Sets.newHashSet(); // 拥有用户列表
	private Set<Menu> menuList = Sets.newHashSet(); // 拥有菜单列表
	private Set<Office> officeList = Sets.newHashSet(); // 按明细设置数据范围
