...
<body>
	...
	<form:form id="searchForm" modelAttribute="dict" action="${ctx}/sys/dict/" method="post" 
		class="breadcrumb form-search form-inline" style = "margin-top:15px;">
		<div id="form_div">
			...
			&nbsp;&nbsp;<label>描述 ：</label><form:input path="description" htmlEscape="false" maxlength="100" class="input-medium form-control"/>
