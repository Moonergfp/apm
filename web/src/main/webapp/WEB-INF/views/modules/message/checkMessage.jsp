...
<head>
	...
	<script type="text/javascript">
        ...
        function check(pubProId,checkStatus){
        	...
        	var url = "${ctx}/publishMessage/checkPubMsg";
        	...
        	$.ajax({
        		...
        		success:function(data){    			
        			window.location.href="${ctx}/publishMessage/checklist";
        		}
        	});
        }
	...
	<div class="div_top">
	     ...
	     <div class="div_bottom">
			<ul class="nav nav-tabs">
	     	    <li><a href="${ctx}/publishProgram/checklist">节目审核</a></li>
	     	    <li class="active"><a href="${ctx}/publishMessage/checklist">消息审核</a></li>
			</ul>
	    </div>
	    <form action="${ctx}/publishMessage/checklist" id="searchForm">
		    <div style="height:34px; line-height:34px;margin-top:10px;">
					<div class="serach row"style="overflow: hidden;float: right; width: 900px;">
							...
							<div class="col-sm-3">
								<input id="search_message_name" name="message.name" class="form-control" type="text" value="" maxlength="100">
							</div>
		    ...
		    <div class="div_table">
		    	<div class="table_div">
					...
					<table id="contentTable" class="table table-striped">
						<thead><tr><td>更新人</td><td>节目名称</td><td>所属机构</td><td>广告商</td><td>提交时间</td><td style="text-align: center;">
						...
						<c:forEach items="${pubPros}" var="pubPro">  
							<tr>
								...
								<td>${pubPro.message.name}</td>
								<td>${pubPro.office.name}</td>
								<c:choose> 
									  <c:when test="${empty pubPro.advertiser}">   
										<td>无</td>
									  </c:when> 
									  <c:otherwise>   
									  	<td>${pubPro.advertiser}</td>  
									  </c:otherwise> 
								</c:choose>
								      	...
								      	<div class="info">
											...
											<div class="program_info">
												<div class="row">
													...
													<div class="col-md-4"><span>节目名称：${pubPro.message.name}</span></div>
													<div class="col-md-4">
														<span>广告商：
														<c:choose> 
															  <c:when test="${empty pubPro.advertiser}">   
