...
<body>
	...
	<form id="listForm" method="post" style = "margin-top:15px;">
				...
				<tr id="${menu.id}" pId="${menu.parent.id ne '1'?menu.parent.id:'0'}">
					...
					<td style="text-align:center;">
						<shiro:hasPermission name="sys:menu:edit">
							...
							<input class="form-control" name="sorts" type="text" value="${menu.sort}" style="width:50px;margin:0;padding:0;text-align:center;">
