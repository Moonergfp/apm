		...
		<div class="settings">
			<div class="navication">
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="${ctx}/terminalSettings/brightSetting">亮度设置</a></li>
			...
			<div class = "showDetail" style = "padding:5px 5px;">
				...
				<div style = "background-color:#D1D1D1;margin-top:10px;">
					<div style = "float:left;padding-top:5px;">
						<span style = "font-weight:bold;font-size:17px;">亮度控制</span>
					</div>
						...
						<li style = "padding-top:10px;">
							<div>
		            			...
		            			<input  class="form-control e1"  value="" placeholder="结束时间"  	
				            		...
				            		style = "width:120px;display:inline"/>
				            	&nbsp;&nbsp;
				            	<button class = "btn btn-primary volSetBtn1" onclick = "showSetVol1(this);">亮度设置</button>
				            	&nbsp;&nbsp;
						...
						<li style = "padding-top:10px;">
							<div>
		            			...
		            			<input  class="form-control e2"  value="" placeholder="结束时间"  	
				            		...
				            		style = "width:120px;display:inline"/>
				            	&nbsp;&nbsp;
				            	<button class = "btn btn-primary volSetBtn2" onclick = "showSetVol2(this);">亮度设置</button>
				            	&nbsp;&nbsp;
						...
						<li style = "padding-top:10px;">
							<div>
		            			...
		            			<input  class="form-control e3"  value="" placeholder="结束时间"  	
				            		...
				            		style = "width:120px;display:inline"/>
				            	&nbsp;&nbsp;
				            	<button class = "btn btn-primary volSetBtn3" onclick = "showSetVol3(this);">亮度设置</button>
				            	&nbsp;&nbsp;
						...
						<li style = "padding-top:10px;">
						    <div>
		            			...
		            			<input  class="form-control e4"  value="" placeholder="结束时间"  	
				            		...
				            		style = "width:120px;display:inline"/>
				            	&nbsp;&nbsp;
				            	<button class = "btn btn-primary volSetBtn4" onclick = "showSetVol4(this);">亮度设置</button>
				            	&nbsp;&nbsp;
				...
				if(flag == 1){
					...
					if(validTime == true)
					{
						if( (timingVol1 == -1) && (timingVol2 == -1) 
							...
							$('.terminalEmptyWarn').empty();
			    			$('.terminalEmptyWarn').append("请设置亮度");
						} else
