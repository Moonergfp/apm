...
<body>
	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" 
		class="form-horizontal select_class" style = "min-width:1000px;padding-top:15px;">
		...
		<div class="form-group">
			<label for=office.id  class="col-sm-2 control-label"><font color="red">*</font>归属机构:</label>
			<div class="col-sm-5">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<form:input path="enname" htmlEscape="false" maxlength="100" class="required form-control"/>
			</div>
		</div>
		
		<div class="form-group">
			<label for="enname" class="col-sm-2 control-label">角色类型:</label>
			<div class="col-sm-5">
				<form:input path="roleType" htmlEscape="false" maxlength="100" class="required form-control"/>
			</div>
		</div>
		
		<div class="form-group">
			<label for="enname" class="col-sm-2 control-label">数据范围:</label>
			<div class="col-sm-9">
				<form:select path="dataScope" class="form-control" style="width: 48%;">
		...
		<div class="form-group">
			<label for="menuTree" class="col-sm-2 control-label">角色授权:</label>
			<div class="col-sm-6">
		...
		<div class="form-actions" style = "margin-left:33%;">
